...
public class AvaxLinkTest extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(AvaxLinkTest.class);

    @Test
    @DisplayName("Tect№1: Articles - AVAX price prediction")
    ...
    void avaxLinkTest() throws IOException {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (AVAX price prediction) AvaxLinkTest- False" + System.currentTimeMillis() + ".png");
            MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()));
            logger.error("org.example.articlesTests (AVAX price prediction) AvaxLinkTest- False");
        }
        ...
        logger.info("(AVAX price prediction) AvaxLinkTest- passed");
    }
}
