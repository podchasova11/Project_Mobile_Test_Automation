...
public class StakingLinkTest extends AbstractTest {
    ...
    @Test
    @DisplayName("Tect№13: Articles - AVAX price prediction")
    ...
    void stakingLinkTest() throws IOException {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (AVAX price prediction) StakingLinkTest- False" + System.currentTimeMillis() + ".png");
            MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()));
            logger.error("org.example.articlesTests (AVAX price prediction) StakingLinkTest- False");
        }
