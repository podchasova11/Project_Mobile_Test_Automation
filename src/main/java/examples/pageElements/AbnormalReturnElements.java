...
public class AbnormalReturnElements extends AbstractPageObject {
    ...
    private MobileElement abnormalReturn;
    @AndroidFindBy(accessibility = "credit risk")
    private MobileElement securities;
    @AndroidFindBy(accessibility = "credit risk")
    private MobileElement predictedReturn;
    @AndroidFindBy(accessibility = "credit risk")
    private MobileElement portfolio;


    public AbnormalReturnElements(AndroidDriver driver) {
        super(driver);
    }
